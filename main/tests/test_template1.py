...
template_obj = Template1(Guest("Daniel Dan"), wed_info)
...
def test_generate():
    assert template_obj.generate_invitation() == os.path.join(get_base_dir(), "main", "invites", "template1_Daniel_Dan.jpg") # os.path.abspath("main/invites/template1_Daniel_Dan.jpg")
